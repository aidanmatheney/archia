namespace Archia.Services
{
    ...
    public abstract class BatchLoggerProviderBase : BatchExecutorBase<LogEntry>, ILoggerProvider
    {
        ...
        protected sealed override Task HandleExceptionAsync(Exception ex, IEnumerable<LogEntry> entries, IServiceProvider scopedServiceProvider)
        {
